...
# Buildings list in the order you provided
buildings = [
    ...
    {"code": "BT",      "full_name": "Building Ten",                                                "address": "1101 SW 112th Ave, Miami, FL 33174",                                                    "google_maps_place_id": "ChIJJyu5wi-_2YgRlgFXScFlpz0"},
    ...
    {"code": "FSB",     "full_name": "Field Support Building",                                      "address": "QJ4C+4F7 Westchester, Florida",                                                         "google_maps_place_id": "Eh5RSjRDKzRGNywgV2VzdGNoZXN0ZXIsIEZMLCBVU0EiJjokCgoN6_FZDxUHKhfQEAsaFAoSCdHoAMLBuNmIEbwGzYFxo2w6"},
    ...
    {"code": "PC",      "full_name": "Charles E. Perry Building (Primera Casa)",                    "address": "Charles Perry Building, 11001 SW 14th St, Miami, FL 33199",                             "google_maps_place_id": "ChIJJ8hAsTG_2YgRTDJ_cPoD3Ok"},
    ...
    {"code": "RB",      "full_name": "Ryder Business Building",                                     "address": "11210 SW 11th St, Miami, FL 33199",                                                     "google_maps_place_id": "ChIJH-UA4y-_2YgRKLt8Xu9BJIM"},
    ...
    {"code": "ZEB",     "full_name": "Sanford L. Ziff Family Education Building",                   "address": "1010 SW 112th Ave, Miami, FL 33174",                                                    "google_maps_place_id": "ChIJ861g9C-_2YgRqvil8hvLNOQ"},
...
for building_data in buildings:
    r = requests.post(f"{BASE_URL}/buildings", json=building_data)
    print("Building:", building_data["code"], r.status_code, r.json())
